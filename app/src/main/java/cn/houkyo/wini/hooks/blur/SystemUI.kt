...
class SystemUI(private val classLoader: ClassLoader, config: ConfigModel) {
    val cornerRadius = config.systemUI.notification.cornerRadius
    val blurRadius = config.systemUI.notification.blurRadius
    val blurBackgroundAlpha = config.systemUI.notification.blurBackgroundAlpha
    val defaultBackgroundAlpha = config.systemUI.notification.defaultBackgroundAlpha
    val qsControlDetailBackgroundAlpha = config.systemUI.quickSetting.controlDetailBackgroundAlpha
